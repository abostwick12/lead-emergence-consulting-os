...
select throws_ok($$select consulting_os.record_coaching_promotion((select id from consulting_private.meeting_notes where content = 'Consultant private coaching note'), (select id from consulting_private.meeting_notes where content = 'Consultant private coaching note'), 'ORGANIZATION_SHARED', 'Unsafe direct promotion', 'No separate abstraction')$$, '23514', null, 'the original private note cannot be promoted as its own derivative');
select lives_ok($$select consulting_os.record_coaching_promotion((select id from consulting_private.meeting_notes where content = 'Consultant private coaching note'), '84000000-0000-4000-8000-000000000008', 'ORGANIZATION_SHARED', 'Abstracted systemic observation without participant detail', 'Names and coaching-specific circumstances removed')$$, 'consultant explicitly promotes a separate abstracted human derivative');
