...
| 3 — Consulting Core | **IN PROGRESS** | **EVIDENCE GATE REQUIRED** | Started 2026-08-10 on `codex/consulting-os-phase3`; exit requires all seven Document 07 requirements and 104 cumulative database assertions to pass. |
...
Repository-boundary verification is recorded in `PHASE-0-ACCEPTANCE-AUDIT.md`. Phases 0, 1, and 2 are complete at their evidence gates. Phase 3 is active under the standing authorization in `PHASE-AUTHORIZATION-2026-08-10.md`; no hosted or production execution is authorized.
