...
| 1 — Security Foundation | **IN PROGRESS** | **AUTHORIZED; EVIDENCE GATE REQUIRED** | Started 2026-08-10 on `codex/consulting-os-phase1`; exit requires every Document 05 and Document 07 security test to pass. |
...
Repository-boundary verification is recorded in `PHASE-0-ACCEPTANCE-AUDIT.md`. Phase 0 is complete. Phase 1 is `IN PROGRESS` under the standing authorization in `PHASE-AUTHORIZATION-2026-08-10.md`.
