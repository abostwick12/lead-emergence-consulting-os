...
describe('alignment and capability workflow', () => {
  ...
  it('accepts bounded practice and activity changes', () => {
    expect(validateAlignmentMutation({ action: 'ADD_PRACTICE', pathwayId: 'p1', practice: 'Reviewed a live exception', conditions: 'Live decision', repetitionTarget: 'Six cases', feedbackMethod: 'Weekly review' }).action).toBe('ADD_PRACTICE');
